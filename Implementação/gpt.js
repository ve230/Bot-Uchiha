...
module.exports = {
  ...
  run: async ({ sock, msg, args }) => {
    if (!args.length) return await sock.sendMessage(msg.key.remoteJid, { text: "❌ Preciso de uma pergunta… até o Itachi ficaria desapontado." });
    ...
    try {
      ...
      console.error(e);
      await sock.sendMessage(msg.key.remoteJid, { text: "⚠️ ChatGPT está furioso… tente novamente mais tarde." });
    }
  }
};