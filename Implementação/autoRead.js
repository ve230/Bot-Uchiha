  ...
  async onMessage({ sock, msg }) {
    try {
      ...
      if (typeof sock.readMessages === "function") {
        ...
        try { await sock.sendReadReceipt(msg.key.remoteJid, msg.key.participant || msg.key.remoteJid, [msg.key.id]); } catch(e){/*ignore*/}
      }
      // otherwise do nothing (best-effort)
    } catch (e) { console.error("autoRead error", e); }
  }
};