...
module.exports = {
  ...
  run: async ({ sock, msg, args }) => {
    ...
    if (!mention) return await sock.sendMessage(msg.key.remoteJid, { text: "❌ Mencione alguém para insultar, preguiçoso." });
    const insults = [
    ...
    await sock.sendMessage(msg.key.remoteJid, { text: `💀 @${mention.split("@")[0]}, ${insult}`, mentions: [mention] });
  }
};