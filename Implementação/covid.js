...
module.exports = {
  ...
  run: async ({ sock, msg, args }) => {
    ...
    try {
      ...
      await sock.sendMessage(msg.key.remoteJid, { text: `🦠 COVID-19 em ${data.country}:\nCasos: ${data.cases}\nMortes: ${data.deaths}\nRecuperados: ${data.recovered}` });
    } catch (e) {
      console.error(e);
      await sock.sendMessage(msg.key.remoteJid, { text: "💀 Não consegui pegar os dados… tente novamente." });
    }
  }
};