...
module.exports = {
    ...
    run: async ({ sock, msg }) => {
        ...
        if (!audio) return sock.sendMessage(jid, { text: "❌ Envie um áudio para transcrever." });
        ...
        try {
            ...
            await sock.sendMessage(jid, { text: `🗣️ Transcrição: ${response.data.text}` });
        } catch (err) {
            await sock.sendMessage(jid, { text: `❌ Erro na IA de voz: ${err.message}` });
        }
    }
};