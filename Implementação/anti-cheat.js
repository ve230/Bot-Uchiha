module.exports = {
    ...
    execute: async (sock, msg) => {
        ...
        if (link.test(body)) return sock.sendMessage(msg.key.remoteJid, { text: "⚠️ Link bloqueado!" });

        // Anti-spam simples
        const lastMsg = sock.lastMessage?.[msg.key.remoteJid];
        if (lastMsg === lower) return sock.sendMessage(msg.key.remoteJid, { text: "⚠️ Spam detectado!" });
