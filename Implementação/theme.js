...
const valid = ["uchiha","akatsuki","sharingan","mangekyou","list","current"];

export default {
  name: "theme",
  description: "Altera o tema do menu: !theme <uchiha|akatsuki|sharingan|mangekyou|list|current>",
  run: async ({ sock, msg, args }) => {
    ...
    // setar tema
    setTheme(arg);
    return await sock.sendMessage(jid, { text: `✅ Tema alterado para: ${arg}\nAbra o menu com !menu` });
  }
};