...
module.exports = {
    ...
    run: async ({ sock, msg, args }) => {
        ...
        if (!user) return sock.sendMessage(jid, { text: "⚠️ Você não está registrado! Use !register <nome>." });
        ...
        await sock.sendMessage(jid, { text: "⚠️ Comando inválido! Use !premium [activate|deactivate]" });
    }
};